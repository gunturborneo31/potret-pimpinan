  ...
  <div class="aspect-[32/10] w-full">
    ...
    <section id="sambutan" class="max-w-4xl mx-auto px-4 py-12 text-center">
      ...
      <p class="text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg">
        Selamat datang di platform <strong>Potret Pimpinan</strong>. Platform ini menyajikan dokumentasi dan informasi kegiatan pimpinan Pemerintah Provinsi Kalimantan Timur secara transparan dan terbuka.
        Kami berkomitmen memberikan akses publik terhadap berbagai dokumen, potret kegiatan, serta permohonan informasi secara digital dan real time.
      </p>
    </section>
