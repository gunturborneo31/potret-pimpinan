...
const props = defineProps({
    users: Array // daftar user untuk select user_id
})
...
// submit form
const submit = () => {
    form.post(route('post-sosmed.store'), {
        onSuccess: () => {
...
<template>
    <Head title="Tambah Data Sosial Media" />
    ...
    <AuthenticatedLayout>
        ...
        <a href="/post-sosmed"
          ...
          ← Kembali ke Daftar Post Social Media
        </a>
      </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option v-for="opt in optionList" :key="opt" :value="opt">
                                        {{ opt }}
                                    </option>
                                </select>
