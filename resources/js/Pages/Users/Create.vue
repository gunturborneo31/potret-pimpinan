...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-xl font-bold text-gray-800 dark:text-white">Tambah User</h2>
    </template>
  ...
  <a href="/users"
    ...
    <div class="py-6 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <form @submit.prevent="submit" class="space-y-4 bg-white dark:bg-gray-800 p-6 rounded shadow">
        ...
        <div>
          <label class="block font-medium text-sm text-gray-700 dark:text-gray-200">Password</label>
